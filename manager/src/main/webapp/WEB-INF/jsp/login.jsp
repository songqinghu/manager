...
<SCRIPT type="text/javascript">
	$(function() {
	 ...
	 function login(){
		    ...
		    //var url = "${contextPath}?name="+encodeURI(encodeURI(name))+"&mail="+encodeURI(encodeURI(mail))+"&tel="+encodeURI(encodeURI(tel))+"&title="+ encodeURI(encodeURI(title))+"&content="+encodeURI(encodeURI(content));
		    //alert(url);
...
<BODY>
	...
	<DIV
		...
		action='/YsddWeb/login.do'>
		<P style="padding: 30px 0px 10px; position: relative;">
			<SPAN class="u_logo"></SPAN> <INPUT class="ipt" id="username" name="username" type="text"
				placeholder="姓名全拼" value="">
		</P>
		...
		<DIV
			...
			<P style="margin: 0px 35px 20px 45px;">
				<SPAN style="float: left;"><A
					style="color: rgb(204, 204, 204);" href="#">忘记密码?请联系刘雨鑫群主</A></SPAN> <SPAN
					style="float: right;"><A
					...
					href="javascript:void(0)" onclick="login()">登录</A> </SPAN>
			</P>
		</DIV>
		</form>
	</DIV>
